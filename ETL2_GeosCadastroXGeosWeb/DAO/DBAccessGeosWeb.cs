...
namespace DAO
{
    public class DBAccessGeosWeb
    {
        public static DbCommand CriarComando(string cmbText, CommandType cmbType, List<DbParameter> listParameter)
        {

            DbProviderFactory factory = DbProviderFactories.GetFactory(DBSettingGeosWeb.ProviderName);
            DbConnection conexao = factory.CreateConnection();
            conexao.ConnectionString = DBSettingGeosWeb.ConnectionString;
        ...
        public static DbParameter CriarParametro(string nomeParametro, DbType tipoParametro, object valorParametro)
        {
            ...
            if (!(parametro == null))
            {
                parametro.ParameterName = DBSettingGeosWeb.SufixoBanco + nomeParametro;
        ...
        {
            SqlConnection conexao = new SqlConnection(DBSettingGeosWeb.ConnectionString);
            try
            {
